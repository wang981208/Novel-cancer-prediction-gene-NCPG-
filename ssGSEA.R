...
gmtFile="COATES_MACROPHAGE_M1_VS_M2_UP.v7.5.1.gmt"          #免疫数据集文件
clusterFile="m6aCluster.txt"       #m6A分型输入文件
setwd("D:\\COAD\\NEW-COAD\\27ssGSEA")     #设置工作目录
...
write.table(ssgseaOut,file="ssGSEA-M12.result.txt",sep="\t",quote=F,col.names=F)
...
pdf(file="boxplot-M12.pdf", width=8, height=6.5)                          #输出图片文件
